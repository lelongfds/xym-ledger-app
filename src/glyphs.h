#ifndef GLYPH_badge_NEM_BPP
        #define GLYPH_badge_NEM_WIDTH 50
        #define GLYPH_badge_NEM_HEIGHT 50
        #define GLYPH_badge_NEM_BPP 2
extern unsigned int const C_badge_NEM_colors[];
extern unsigned char const C_badge_NEM_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_badge_NEM;
        #endif // GLYPH_badge_NEM_BPP
...
extern unsigned char const C_badge_transaction_bitmap[];
        ...
        #endif // OS_IO_SEPROXYHAL
#ifndef GLYPH_icon_NEM_BPP
        #define GLYPH_icon_NEM_WIDTH 14
        #define GLYPH_icon_NEM_HEIGHT 14
        #define GLYPH_icon_NEM_BPP 1
extern unsigned int const C_icon_NEM_colors[];
extern unsigned char const C_icon_NEM_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_icon_NEM;
        #endif // GLYPH_icon_NEM_BPP
        #endif // OS_IO_SEPROXYHAL
